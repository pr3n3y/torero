...
const ProcessSection = () => {
  return (
    <section className="pb-44 relative overflow-hidden">
      <WaveShape
        wave={
          "https://nifty.bold-themes.com/swirl/wp-content/uploads/sites/5/2020/08/Wave_grey_bottom_left_shape_01.png"
        }
        className="bottom-0"
      />

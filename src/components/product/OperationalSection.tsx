...
const OperationalSection = () => {
  return (
    <section className="relative py-20 overflow-hidden h-[130vh]">
      {/* Background with blob shapes */}
      <div
        className="absolute inset-0 bg-cover bg-center h-[130vh]"
        style={{
          backgroundImage: `url(https://nifty.bold-themes.com/swirl/wp-content/uploads/sites/5/2020/09/background_about_us_01.jpg)`,
        }}
      >
      ...
      <WaveShape
        wave="https://nifty.bold-themes.com/swirl/wp-content/uploads/sites/5/2020/09/top_wave_03.png"
        className="top-0"
      />
      <WaveShape
        wave="https://nifty.bold-themes.com/swirl/wp-content/uploads/sites/5/2020/09/bottom_wave_01.png"
        className="bottom-0"
      />

      <div className="container mx-auto px-4 relative z-10 h-full">
        <div className="grid lg:grid-cols-[25%,75%] gap-12 h-full  items-center">

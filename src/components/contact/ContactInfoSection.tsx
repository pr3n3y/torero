...
const ContactInfoSection = () => {
  const offices = [
    ...
    },
    {
      ...
      zip: "9 am to 7 pm EST",
    },
    {
      label: "CALIFORNIA OFFICE",
      city: "LOS ANGELES",
      address: "31 West 65th Street",
      zip: "LA 34561",
    },
    {
      label: "CANADA OFFICE",
      city: "TORONTO",
      address: "226 Yong Street",
      zip: "TO 99123",
    },
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div className="animate-fade-in">
            ...
            {/* Social Media */}
            <div>
              <h4 className="text-lg font-display text-foreground mb-4">Social Media</h4>
              <div className="flex gap-3">
                {["facebook", "twitter", "instagram", "linkedin"].map((social) => (
                  ...
                  >
                    {social === "facebook" && (
                      <svg width="10" height="18" viewBox="0 0 8 16" fill="currentColor">
                    ...
                    {social === "twitter" && (
                      <svg width="18" height="14" viewBox="0 0 16 14" fill="currentColor">
